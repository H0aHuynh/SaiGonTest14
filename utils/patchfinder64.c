...
addr_t find_cs_blob_generation_count_fallback_adrpfunc(void){
...
addr_t find_cs_blob_generation_count_fallback(void){
...
addr_t find_cs_blob_generation_count(void)
{
